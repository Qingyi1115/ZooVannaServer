...
import {DataTypes, Model, InferAttributes, InferCreationAttributes,
    BelongsToGetAssociationMixin, BelongsToSetAssociationMixin, CreationOptional} from "Sequelize";
import {conn} from '../db';
import { InHouse } from "./inHouse";


class FacilityLog extends Model<InferAttributes<FacilityLog>, InferCreationAttributes<FacilityLog>> {
